...
int main(){ // función principal
	...
	while(n-- >0){// un ciclo en el que el valor de n ingresado va decrementando hasta que llegue a cero
		cout<<"Hello, World!\n";// se imprime el mensaje las veces que el usuario indique con un salto de línea
	}
